...
router.get('/statistics', authenticate, (req, res, next) =>
  appelOffreController.getStatistics(req, res, next)
);
...
router.post('/:id/apply', authenticate, (req, res, next) =>
  appelOffreController.apply(req, res, next)
);

// GET /api/calls-for-tenders/:id/applications - Lister candidatures
router.get('/:id/applications', authenticate, (req, res, next) =>
  appelOffreController.listApplications(req, res, next)
);

// PUT /api/calls-for-tenders/:id/applications/:applicationId/accept
router.put('/:id/applications/:applicationId/accept', authenticate, (req, res, next) =>
  appelOffreController.acceptApplication(req, res, next)
);

// PUT /api/calls-for-tenders/:id/applications/:applicationId/reject
router.put('/:id/applications/:applicationId/reject', authenticate, (req, res, next) =>
  appelOffreController.rejectApplication(req, res, next)
);
